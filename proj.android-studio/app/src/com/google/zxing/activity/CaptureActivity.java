...
public class CaptureActivity extends AppCompatActivity implements Callback {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnAlbum = (Button) findViewById(R.id.btn_photo);
        btnAlbum.setOnClickListener(albumOnClick);

        btnMyQRCode = (Button) findViewById(R.id.btn_qrcode);
        btnMyQRCode.setOnClickListener(myQRCodeOnClick);
...
//		cancelScanButton = (Button) this.findViewById(R.id.btn_cancel_scan);
        ...
        for (int i = 0; i < info.size(); i++) {
            Log.d("CaptureActivity " + i, "onCreate: task id = " + info.get(i).id);
        }
    }
    ...
    private View.OnClickListener albumOnClick = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            startActivityForResult(innerIntent, Constant.REQ_SELECT_PHOTO);
        }
    };
     ...
     * 展示我的二維碼
     */
    private View.OnClickListener myQRCodeOnClick = new View.OnClickListener() {
        @Override
        public void onClick(View view) {
            Intent intent_cur = getIntent();
            String headUrl = intent_cur.getStringExtra(Constant.INTENT_EXTRA_KEY_QR_HEAD);
            String des = intent_cur.getStringExtra(Constant.INTENT_EXTRA_KEY_QR_DESCRIPTION);
            ...
            intent.putExtra(Constant.INTENT_EXTRA_KEY_QR_DESCRIPTION, des);
            startActivityForResult(intent, Constant.REQ_QR_CODE_DISPLAY);
    ...
    private void handleAlbumPic(Intent data) {
        ...
        mProgress.setMessage(getString(R.string.qrcode_scanning));
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if (result != null) {
                    ...
                    Toast.makeText(CaptureActivity.this, R.string.qrcode_scan_error, Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
